...
def new_pwbp(notebook):
    ...
    roof_stress_label = tk.Label(frame, text="Mean H.Stress in Roof (Shir) [MPa]:",
                                 font=("Inter", 14, "bold"))
    roof_stress_label.place(x=130, y=230 - 60)
    entry_roof_stress = tk.Entry(frame, width=10, font=("Inter", 14, "bold"))
    entry_roof_stress.place(x=420, y=227 - 60)

    floor_stress_label = tk.Label(frame, text="Mean H.Stress in Floor (Shif) [MPa]:",
                                  font=("Inter", 14, "bold"))
    floor_stress_label.place(x=130, y=257 - 60)
    entry_floor_stress = tk.Entry(frame, width=10, font=("Inter", 14, "bold"))
    entry_floor_stress.place(x=420, y=258 - 60)

    pillar_stress_label = tk.Label(frame, text="Mean H.Stress in Pillar (Ship) [MPa]:",
                                   font=("Inter", 14, "bold"))
    pillar_stress_label.place(x=130, y=285 - 60)
    entry_pillar_stress = tk.Entry(frame, width=10, font=("Inter", 14, "bold"))
    entry_pillar_stress.place(x=420,y=289 - 60)
...
def open_next_screen(notebook):
    ...
    btn_existing_pwbp = tk.Button(frame, text="Evaluate the Existing Barrier", command=lambda: existing_pwbp(notebook),
