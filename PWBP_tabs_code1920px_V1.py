...
def gui_test2(notebook):
    ...
    tooltip_label = tk.Label(frame, textvariable=tooltip_text, font=("Arial", 8, "bold"), bg="yellow", relief="solid",
                             borderwidth=1)
    tooltip_label.place_forget()

    # Create a tooltip label
    tooltip_text = tk.StringVar()
    tooltip_label = tk.Label(frame, textvariable=tooltip_text, font=("Arial", 8, "bold"),
