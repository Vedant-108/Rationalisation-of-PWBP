...
def new_pwbp():
    ...
    cover_depth_label = tk.Label(root, text='Cover Depth (D) [m]:', font=("Helvetica", 12))
    cover_depth_label.grid(row=0, column=0, padx=10, pady=2, sticky='w')
    entry_cover_depth = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_cover_depth.grid(row=0, column=1, padx=10, pady=2)
    #entry_cover_depth.insert(tk.END, '350')

    gallery_width_label = tk.Label(root, text='Gallery Width (Wg) [m]:', font=("Helvetica", 12))
    gallery_width_label.grid(row=1, column=0, padx=10, pady=2, sticky='w')
    entry_gallery_width = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_gallery_width.grid(row=1, column=1, padx=10, pady=2)

    pillar_width_label = tk.Label(root, text='Pillar Width (Wp) [m]:', font=("Helvetica", 12))
    pillar_width_label.grid(row=2, column=0, padx=10, pady=2, sticky='w')
    entry_pillar_width = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_pillar_width.grid(row=2, column=1, padx=10, pady=2)

    water_head_label = tk.Label(root, text='Water Head (H) [m]:', font=("Helvetica", 12))
    water_head_label.grid(row=3, column=0, padx=10, pady=2, sticky='w')
    entry_water_head = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_water_head.grid(row=3, column=1, padx=10, pady=2)

    roof_influence_label = tk.Label(root, text='Influence Zone of Immediate Roof (Tr) [m]:', font=("Helvetica", 12))
    roof_influence_label.grid(row=6, column=0, padx=10, pady=2, sticky='w')
    entry_roof_influence = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_roof_influence.grid(row=6, column=1, padx=10, pady=2)

    pillar_height_label = tk.Label(root, text='Height of the Coal Pillar (Tp) [m]:', font=("Helvetica", 12))
    pillar_height_label.grid(row=7, column=0, padx=10, pady=2, sticky='w')
    entry_pillar_height = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_pillar_height.grid(row=7, column=1, padx=10, pady=2)

    floor_influence_label = tk.Label(root, text='Influence Zone of Immediate Floor (Tf) [m]:', font=("Helvetica", 12))
    floor_influence_label.grid(row=8, column=0, padx=10, pady=2, sticky='w')
    entry_floor_influence = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_floor_influence.grid(row=8, column=1, padx=10, pady=2)

    roof_modulus_label = tk.Label(root, text="Young’s Modulus of Roof(Er) [GPa]:", font=("Helvetica", 12))
    roof_modulus_label.grid(row=10, column=0, padx=10, pady=2, sticky='w')
    entry_roof_modulus = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_roof_modulus.grid(row=10, column=1, padx=10, pady=2)

    floor_modulus_label = tk.Label(root, text="Young’s Modulus of Floor(Ef) [GPa]:", font=("Helvetica", 12))
    floor_modulus_label.grid(row=11, column=0, padx=10, pady=2, sticky='w')
    entry_floor_modulus = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_floor_modulus.grid(row=11, column=1, padx=10, pady=2)

    coal_modulus_label = tk.Label(root, text="Young’s Modulus of Coal (Ec) [GPa]:", font=("Helvetica", 12))
    coal_modulus_label.grid(row=12, column=0, padx=10, pady=2, sticky='w')
    entry_coal_modulus = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_coal_modulus.grid(row=12, column=1, padx=10, pady=2)

    roof_stress_label = tk.Label(root, text="Mean Horizontal Stress in Immediate Roof (Shir) [MPa]:",
                                 font=("Helvetica", 12))
    roof_stress_label.grid(row=14, column=0, padx=10, pady=2, sticky='w')
    entry_roof_stress = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_roof_stress.grid(row=14, column=1, padx=10, pady=2)

    floor_stress_label = tk.Label(root, text="Mean Horizontal Stress in Immediate Floor (Shif) [MPa]:",
                                  font=("Helvetica", 12))
    floor_stress_label.grid(row=15, column=0, padx=10, pady=2, sticky='w')
    entry_floor_stress = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_floor_stress.grid(row=15, column=1, padx=10, pady=2)

    pillar_stress_label = tk.Label(root, text="Mean Horizontal Stress in Pillar (Ship) [MPa]:", font=("Helvetica", 12))
    pillar_stress_label.grid(row=16, column=0, padx=10, pady=2, sticky='w')
    entry_pillar_stress = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_pillar_stress.grid(row=16, column=1, padx=10, pady=2)

    roof_compressive_strength_label = tk.Label(root, text="Mean Compressive Strength of Immediate Roof (Scr) [MPa]:",
                                               font=("Helvetica", 12))
    roof_compressive_strength_label.grid(row=0, column=3, padx=10, pady=2, sticky='w')
    entry_roof_compressive_strength = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_roof_compressive_strength.grid(row=0, column=4, padx=10, pady=2)

    pillar_compressive_strength_label = tk.Label(root, text="Mean Compressive Strength of Pillar (Scp) [MPa]:",
                                                 font=("Helvetica", 12))
    pillar_compressive_strength_label.grid(row=1, column=3, padx=10, pady=2, sticky='w')
    entry_pillar_compressive_strength = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_pillar_compressive_strength.grid(row=1, column=4, padx=10, pady=2)

    floor_compressive_strength_label = tk.Label(root, text="Mean Compressive Strength of Immediate Floor (Scf) [MPa]:",
                                                font=("Helvetica", 12))
    floor_compressive_strength_label.grid(row=2, column=3, padx=10, pady=2, sticky='w')
    entry_floor_compressive_strength = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_floor_compressive_strength.grid(row=2, column=4, padx=10, pady=2)

    roof_tensile_strength_label = tk.Label(root, text="Mean Tensile Strength of Immediate Roof (Str) [MPa]:",
                                           font=("Helvetica", 12))
    roof_tensile_strength_label.grid(row=4, column=3, padx=10, pady=2, sticky='w')
    entry_roof_tensile_strength = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_roof_tensile_strength.grid(row=4, column=4, padx=10, pady=2)

    pillar_tensile_strength_label = tk.Label(root, text="Mean Tensile Strength of Pillar (Stp) [MPa]:",
                                             font=("Helvetica", 12))
    pillar_tensile_strength_label.grid(row=5, column=3, padx=10, pady=2, sticky='w')
    entry_pillar_tensile_strength = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_pillar_tensile_strength.grid(row=5, column=4, padx=10, pady=2)

    floor_tensile_strength_label = tk.Label(root, text="Mean Tensile Strength of Immediate Floor (Stf) [MPa]:",
                                            font=("Helvetica", 12))
    floor_tensile_strength_label.grid(row=6, column=3, padx=10, pady=2, sticky='w')
    entry_floor_tensile_strength = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_floor_tensile_strength.grid(row=6, column=4, padx=10, pady=2)

    roof_permeability_label = tk.Label(root, text="Permeability of Immediate Roof (Kr) [mD]:", font=("Helvetica", 12))
    roof_permeability_label.grid(row=8, column=3, padx=10, pady=2, sticky='w')
    entry_roof_permeability = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_roof_permeability.grid(row=8, column=4, padx=10, pady=2)

    pillar_permeability_label = tk.Label(root, text="Permeability of Coal Pillar (Kp) [mD]:", font=("Helvetica", 12))
    pillar_permeability_label.grid(row=9, column=3, padx=10, pady=2, sticky='w')
    entry_pillar_permeability = tk.Entry(root, width=10, font=("Helvetica", 12))
    entry_pillar_permeability.grid(row=9, column=4, padx=10, pady=2)

    floor_permeability_label = tk.Label(root, text="Permeability of Immediate Floor (Kf) [mD]:", font=("Helvetica", 12))
    floor_permeability_label.grid(row=10, column=3, padx=10, pady=2, sticky='w')
    entry_floor_permeability = tk.Entry(root, width=10, font=("Helvetica", 12))
    ...
    # Create the r-button
    r_button = tk.Button(root, text="Rationalise the Width of PWBP", command=press_buttons, width=20, height=2,
                         font=("Helvetica", 12))
    r_button.grid(row=20, column=3, columnspan=2, padx=10, pady=5, sticky="we")

    # Exit button
    exit_button = tk.Button(root, text="Exit", command=root.quit, width=20, height=2, font=("Helvetica", 12))
...
def existing_pwbp():
    root = tk.Tk()
    root.title("Design of Existing PWBP")
    ...
    calculate_button = tk.Button(root, text="Adequacy Assessment", command=calculate_values, width=25, height=1,
                                 font=("Helvetica", 12))
    ...
    # Create the r-button
    r_button = tk.Button(root, text="Rationalise the Width of PWBP", command=gui_test2, width=25, height=1,
                         font=("Helvetica", 12))
    ...
    exit_button = tk.Button(root, text="Exit", command=root.quit, width=20, height=1, font=("Helvetica", 12))
