...
def new_pwbp(notebook):
    ...
    # Create input fields
    # here the old placement of values are done we are updating the program --
    ...
    pillar_permeability_dropdown = ttk.Combobox(frame, width=10,
                                                values=list(pillar_permeability_values.keys()) + ["Type Value"],
                                                state='readonly')
    ...
    floor_permeability_dropdown = ttk.Combobox(frame, width=10,
                                               values=list(floor_permeability_values.keys()) + ["Type Value"],
                                               state='readonly')
...
def existing_pwbp(notebook):
    ...
    calculate_button = tk.Button(frame, text="Adequacy Assessment", command=calculate_values, width=25, height=1,
                                 font=("Helvetica", 12))
    ...
    # Create the r-button
    r_button = tk.Button(frame, text="Rationalise the Width of PWBP", command=lambda: gui_test2(notebook), width=25, height=1,
                         font=("Helvetica", 12))
    ...
    exit_button = tk.Button(frame, text="Quit", command=frame.quit, width=20, height=1, font=("Helvetica", 12))
