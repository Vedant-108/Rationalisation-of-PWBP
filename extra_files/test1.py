...
canvas = tk.Canvas(table_frame, width=1000, height=100 , relief="sunken" , borderwidth=1 , bg="#ADADF5")
canvas.pack()
...
tooltip_label = tk.Label(root, textvariable=tooltip_text, font=("Arial", 12, "bold"), bg="yellow", relief="solid", borderwidth=1)
tooltip_label.place_forget()
